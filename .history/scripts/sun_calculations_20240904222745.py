...
def get_next_sunrise_sunset(t):
    ...
    t1 = ts.utc((dt + timedelta(days=2)).year, (dt + timedelta(days=2)).month, (dt + timedelta(days=2)).day)
...
def get_twilight_times(t):
    # Convertir l'objet Time en datetime
    dt = t.utc_datetime()
    ...
    # Utiliser almanac.dark_twilight_day pour obtenir les périodes de crépuscule et de jour/nuit
...
astronomical_dusk_start = dawn_time(t, 'astronomical_dusk', 'start')
astronomical_dusk_end = dawn_time(t, 'astronomical_dusk', 'end')
nautical_dusk_start = dawn_time(t, 'nautical_dusk', 'start')
nautical_dusk_end = dawn_time(t, 'nautical_dusk', 'end')
civil_dusk_start = dawn_time(t, 'civil_dusk', 'start')
civil_dusk_end = dawn_time(t, 'civil_dusk', 'end')
civil_dawn_start = dawn_time(t, 'civil_dawn', 'start')
civil_dawn_end = dawn_time(t, 'civil_dawn', 'end')
nautical_dawn_start = dawn_time(t, 'nautical_dawn', 'start')
nautical_dawn_end = dawn_time(t, 'nautical_dawn', 'end')
astronomical_dawn_start = dawn_time(t, 'astronomical_dawn', 'start')
astronomical_dawn_end = dawn_time(t, 'astronomical_dawn', 'end')
...
sun_distance_au = get_sun_altaz(t)[2].au
sun_distance_km = get_sun_altaz(t)[2].km
sun_ra = get_sun_ra_dec(t)[0]
sun_declination = get_sun_ra_dec(t)[1].dstr(places=1, warn=True, format=u'{0}{1}° {2:02}′ {3:02}.{4:0{5}}″')
...
twilight_times = get_twilight_times(t)
...
print(f"Current Sun Distance: {sun_distance_au:.7f} AU / {sun_distance_km:.2f} km")
print(f"Current Sun RA: {sun_ra}")
print(f"Current Sun Declination: {sun_declination}")
...
print(f"Is the Sun above 6 degrees? {twilight(t, 6)}")
print(f"Astronomical Dusk Start: {astronomical_dusk_start}")
print(f"Astronomical Dusk End: {astronomical_dusk_end}")
print(f"Nautical Dusk Start: {nautical_dusk_start}")
print(f"Nautical Dusk End: {nautical_dusk_end}")
print(f"Civil Dusk Start: {civil_dusk_start}")
print(f"Civil Dusk End: {civil_dusk_end}")
print(f"Civil Dawn Start: {civil_dawn_start}")
print(f"Civil Dawn End: {civil_dawn_end}")
print(f"Nautical Dawn Start: {nautical_dawn_start}")
print(f"Nautical Dawn End: {nautical_dawn_end}")
print(f"Astronomical Dawn Start: {astronomical_dawn_start}")
print(f"Astronomical Dawn End: {astronomical_dawn_end}")
