...
def get_moon_libration_longitude(t):
    moon = eph['moon']
    astrometrics = cherbourg_observer.at(t).observe(moon)
    apparent = astrometrics.apparent()
    geocentric = apparent.frame_latlon('geocentric')
    return geocentric[1].degrees  # Longitude
...
print(f"Current Moon Libration Longitude: {get_moon_libration_longitude(t)} degrees")