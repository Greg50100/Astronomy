...
print(f"Next Lunar Eclipse: {get_lunar_eclipse(t0, t365)[0][0].utc_strftime('%Y-%m-%d %H:%M')}")
# Supposons que get_lunar_eclipse retourne un tuple (eclipse, ...)
eclipse, *_ = get_lunar_eclipse(t0, t365)

# Accédez à l'attribut t de l'objet eclipse
print({eclipse.ts.utc_strftime('%Y-%m-%d %H:%M'), 'y={}'.format(y)})
