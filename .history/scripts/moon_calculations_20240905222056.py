...
print(f"Lunar Eclipses: {get_lunar_eclipse(t0, t365)[0].utc_strftime('%Y-%m-%d %H:%M')}, y={get_lunar_eclipse(t0, t365)[1][1]}, {eclipselib.LUNAR_ECLIPSES[get_lunar_eclipse(t0, t365)[1][1]]}")
