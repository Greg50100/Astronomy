...
def get_apparent_diameter(distance, some_other_argument):
    astrometrics = cherbourg_observer.at(t).observe(eph['moon'])
    apparent = astrometrics.apparent()
    distance = apparent.distance().km
    moon_diameter_km = 3474.2  # Diamètre moyen de la Lune en km
    apparent_diameter = degrees(atan2(moon_diameter_km, distance))
...
print(f"Current Moon Apparent Diameter: {get_apparent_diameter(get_moon_altaz(t)[2].au)} arcseconds")
