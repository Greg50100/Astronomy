...
print(f"Current Moon Distance: {get_observing_moon_location(t)[2].km:.2f} km")
print(f"Current Moon Apparent RA: {get_apparent_ra_dec(t)[0]}")
print(f"Current Moon Apparent Declination: {get_apparent_ra_dec(t)[1].dstr(places=1, warn=True, format=u'{0}{1}° {2:02}′ {3:02}.{4:0{5}}″')}")
